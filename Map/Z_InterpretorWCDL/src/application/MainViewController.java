...
//		);
		...
		IStatement stm22 = new CompStatement(new NewH("v1",new ConstExpression(2)),
				new CompStatement(new NewH("v2",new ConstExpression(3)),
				new CompStatement(new NewH("v3",new ConstExpression(4)),
				new CompStatement(new NewLatch("cnt",new ReadH("v2")),
				new CompStatement(new ForkStatement(new CompStatement(new WriteH("v1",new ArithmeticExpression('*',new ReadH("v1"),new ConstExpression(10))),
													new CompStatement(new PrintStatement(new ReadH("v1")),new CountDown("cnt")))),		
				new CompStatement(new ForkStatement(new CompStatement(new WriteH("v2",new ArithmeticExpression('*',new ReadH("v2"),new ConstExpression(10))),
													new CompStatement(new PrintStatement(new ReadH("v2")),new CountDown("cnt")))),
				new CompStatement(new ForkStatement(new CompStatement(new WriteH("v3",new ArithmeticExpression('*',new ReadH("v3"),new ConstExpression(10))),
													new CompStatement(new PrintStatement(new ReadH("v3")),new CountDown("cnt")))),
				new CompStatement(new Await("cnt"),
				new CompStatement(new CountDown("cnt"),new PrintStatement(new VarExpression("cnt")))))))))));
				
		
				
		ObservableList<IStatement> list = FXCollections.observableArrayList();
		list.addAll(stm,stm1,stm2,stm3,stm4,stm5,stm6,stm7,stm8,stmex,stm9,stm10,stm11,stm12,stm13,stm14,stm16,stm18,stm19,stm20,stm21,stm22);
		return list;
	}
