...
public class PrgState 
{
	...
	private ILockTable<Integer,Integer> lock;
	...
	public PrgState(IStack<IStatement> exeS, IDictionary<String,Integer> symbolT, IList<Integer> ot, IFileTable<Integer,FileData> ft, IHeap<Integer,Integer> hep, ILockTable<Integer,Integer> locks, IStatement prog)
	{
		exeStack = exeS;
		symbolTable = symbolT;
		out = ot;
	...
	public String toString()
	{
		...
		sb.append("   Heap:   "+heap+"\n");
		sb.append("   LockTable:   "+lock+"\n");
		sb.append("   Original program:   "+originalProg+"\n");
		return sb.toString();
	}

	public ILockTable<Integer, Integer> getLock() {
		return lock;
	}

	public void setLock(ILockTable<Integer, Integer> lock) {
		this.lock = lock;
	}
