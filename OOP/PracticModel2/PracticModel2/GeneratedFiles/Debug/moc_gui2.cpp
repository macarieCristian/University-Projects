...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_gui2_t, stringdata0) + ofs \
...
const QMetaObject gui2::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_gui2.data,
...
void *gui2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gui2.stringdata0))
        return static_cast<void*>(const_cast< gui2*>(this));
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< gui2*>(this));
